...
export interface ApiGridGrid extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Homepage spatial canvas panels';
    displayName: 'Grid';
    pluralName: 'grids';
    singularName: 'grid';
  };
  ...
  attributes: {
    ...
    kind: Schema.Attribute.Enumeration<
      ['hero', 'image', 'text', 'index', 'quote']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'text'>;
    label: Schema.Attribute.String & Schema.Attribute.Required;
    localCss: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::grid.grid'> &
      Schema.Attribute.Private;
    meta: Schema.Attribute.String & Schema.Attribute.Required;
