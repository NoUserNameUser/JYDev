...
const resumeGrids = [
  {
    ...
    orderIndex: 0,
    elements: [
      { __component: "grid.background", color: "#f8f6ef" },
      {
        __component: "grid.shape",
      ...
      { __component: "grid.button", label: "Email Jackie", href: emailUrl, variant: "primary", openInNewTab: false },
      { __component: "grid.link", label: "LinkedIn", href: linkedinUrl, openInNewTab: true },
      { __component: "grid.link", label: "GitHub", href: githubUrl, openInNewTab: true },
    ],
  ...
  },
  {
    ...
    orderIndex: 1,
    elements: [
      { __component: "grid.background", color: "#101820" },
      {
        __component: "grid.shape",
      ...
      { __component: "grid.button", label: "Contact", href: emailUrl, variant: "secondary" },
    ],
  ...
  },
  {
    ...
    orderIndex: 2,
    elements: [
      { __component: "grid.background", color: "#fffaf0" },
      {
        __component: "grid.shape",
        name: "Reusable block",
        shape: "rectangle",
      ...
      { __component: "grid.button", label: "LinkedIn Proof", href: linkedinUrl, variant: "primary", openInNewTab: true },
    ],
  ...
  },
  {
    ...
    orderIndex: 3,
    elements: [
      { __component: "grid.background", color: "#e8eef2" },
      {
        __component: "grid.shape",
  ...
  },
  {
    ...
    orderIndex: 4,
    elements: [
      { __component: "grid.background", color: "#f2f0ea" },
      {
        __component: "grid.shape",
        name: "Service node",
        shape: "circle",
  ...
  },
  {
    ...
    orderIndex: 5,
    elements: [
      { __component: "grid.background", color: "#f6f2f7" },
      {
        __component: "grid.text",
      ...
      { __component: "grid.button", label: "Email for details", href: emailUrl, variant: "secondary" },
    ],
  ...
  },
  {
    ...
    orderIndex: 6,
    elements: [
      { __component: "grid.background", color: "#eff5f1" },
      {
        __component: "grid.shape",
        name: "Angular mark",
        shape: "triangle",
  ...
  },
  {
    ...
    orderIndex: 7,
    elements: [
      { __component: "grid.background", color: "#111313" },
      { __component: "grid.shape", name: "Worker lane", shape: "rectangle", color: "rgba(122, 220, 168, 0.18)", width: "72%", height: "9px", x: "50%", y: "30%", zIndex: 1 },
      { __component: "grid.shape", name: "Worker lane", shape: "rectangle", color: "rgba(122, 220, 168, 0.16)", width: "58%", height: "9px", x: "50%", y: "50%", zIndex: 1 },
      { __component: "grid.shape", name: "Worker lane", shape: "rectangle", color: "rgba(122, 220, 168, 0.14)", width: "66%", height: "9px", x: "50%", y: "70%", zIndex: 1 },
      {
        __component: "grid.text",
      ...
      { __component: "grid.button", label: "GitHub", href: githubUrl, variant: "primary", openInNewTab: true },
    ],
  ...
  },
  {
    ...
    orderIndex: 8,
    elements: [
      { __component: "grid.background", color: "#f7f4ed" },
      {
        __component: "grid.text",
  ...
  },
  {
    ...
    orderIndex: 9,
    elements: [
      { __component: "grid.background", color: "#edf1f5" },
      {
        __component: "grid.shape",
      ...
      { __component: "grid.button", label: "Start a conversation", href: emailUrl, variant: "primary" },
    ],
    localCss: premiumGridCss.education,
  },
];

async function syncResumeGrids(strapi) {
  const documents = strapi.documents("api::grid.grid");
  const existingGrids = await documents.findMany({
    pagination: { pageSize: 100 },
    populate: ["elements"],
    sort: "orderIndex:asc",
  });
  const byOrder = new Map(existingGrids.map((grid) => [grid.orderIndex, grid]));
  const wantedOrders = new Set(resumeGrids.map((grid) => grid.orderIndex));

  for (const grid of resumeGrids) {
    const existing = byOrder.get(grid.orderIndex);
    const data = {
      label: grid.label,
      kicker: grid.kicker,
      meta: grid.meta,
    ...
    if (existing?.documentId) {
      await documents.update({ documentId: existing.documentId, data });
    } else {
  ...
  for (const grid of existingGrids) {
    if (!wantedOrders.has(grid.orderIndex) && grid.documentId) {
      await documents.delete({ documentId: grid.documentId });
    }
  }
}
